                 ...
                 <div className="relative mt-1">
                    ...
                    ">
                        <Combobox.Input
                           ...
                           >
                              <ChevronUpDownIcon className="h-2 w-5 text-gray-400" aria-hidden="true" />
                    ...
                    <Transition
                      ...
                      afterLeave={() => setQuery('')}
                    >
                         <Combobox.Options className={`absolute mt-1 max-h-60 w-full overflow-hidden rounded-md bg-gray-900
